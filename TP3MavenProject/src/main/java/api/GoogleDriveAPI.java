...
/**
 * Class GoogleDriveAPI Utilise l'API de Drive pour se connecter et chercher les
...
public class GoogleDriveAPI {
	...
	public static Credential authorize() throws IOException {
		// Load client secrets.
		InputStream in = GoogleDriveAPI.class.getResourceAsStream("client_secret.json");
