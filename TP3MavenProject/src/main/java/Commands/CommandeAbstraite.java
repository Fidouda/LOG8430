...
/**
 * Class CommandeAbstraite Classe abstraite pour les commandes. Contient des
 * methodes communes aux commandes
 * 
...
public abstract class CommandeAbstraite extends Observable {
	...
	/**
	 * Fonction de modification pour l'attribut chemin_, appelle la fonction
	 * clear()
	 * 
	 * @param chemin
	 */
