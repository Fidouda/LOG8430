...
public class DriveSample {
  ...
  private static final String UPLOAD_FILE_PATH =
      "C:\\Users\\Sylvester\\Documents\\drivetest\\test.txt";
  private static final String DIR_FOR_DOWNLOADS =
      "C:\\Users\\Sylvester\\Documents\\EclispeWorkspace\\google-api-java-client-samples\\_download_tests";
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      java.util.List<File> driveFiles = new ArrayList();

      driveFiles = retrieveAllFiles(drive);
  ...
  private static java.util.List<File> retrieveAllFiles(Drive service) throws IOException {
